        ...
        <div className='gpt3__blog section__padding' id="blog">
            ...
            <div className='gpt3__blog-container'>
                ...
                <div className='gpt3__blog-container-groupB'>
                    ...
                    <Article imgUrl={blog03} date="11 oct 2020" techno={[< FaVuejs color="#3FB17F" />, < SiMysql color="#DD8B00" />]} title="Système de gestion client (CRM) permettant à des commerciaux de gérer leur portfeuille de praticien. Projet pédagogique." />
                    <Article imgUrl={blog04} date="4 avr 2020" techno={[< SiRubyonrails color="#C60700" />, < SiMysql color="#DD8B00" />]} title="Application de mise ne relation entre des pilotes et des passagers. Il s'agit d'un projet de fin d'étude au Wagon." />
                    <Article imgUrl={blog05} date="20 juil 2021" techno={[< FaVuejs color="#3FB17F" />, < SiMysql color="#DD8B00" />, < FaPhp color="#5D7DB0" />]} title="Application de musique basée sur l'API de Deezers. Projet pédagogique à destination d'élèves de Bachelor." />
                </div>
            </div>
        </div>
    );
