        ...
        <div className='gpt3__blog section__padding' id="blog">
            ...
            <div className='gpt3__blog-container'>
                ...
                <div className='gpt3__blog-container-groupB'>
                    ...
                    <Article imgUrl={blog05} date="12 dec 2021" techno={[< FaVuejs color="#3FB17F" />, < SiMysql color="#DD8B00" />, < FaPhp color="#5D7DB0" />]} title="Application de musique basée sur l'API de Deezers. Projet pédagogique à destination d'élèves de Bachelor." />
                </div>
            </div>
        </div>
    );
